...
output_dim = k2 - k1 + 1
model_name = 'MLP' #
hidden_layer_sizes=(100, 200, 100) # MLP architecture
...
# MLP inputs shape from (nb_days, 2*output_dim) to (nb_days * output_dim, 2)
...
# Single output model
####################
# MLP targets shape from (nb_days, output_dim) to (nb_days * output_dim,)
